...
- age: side by side boxplot and t-test
...
- workclass: mosaic plot and chi-square test
...
- fnlwgt: side by side box plots and t-test
...
- education: mosaic plot and chisq test
```{R}
  ...
  chisq.test(education_target_table, simulate.p.value = TRUE)
  plot()
```
